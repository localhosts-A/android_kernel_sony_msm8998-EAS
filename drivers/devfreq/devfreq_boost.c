...
MODULE_PARM_DESC(devfreq_wake_boost_duration_ms, "The duration in ms of the devfreq_wake_boost");
...
MODULE_PARM_DESC(devfreq_input_boost_duration_ms, "The duration in ms of the devfreq_input_boost");
